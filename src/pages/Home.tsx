              ...
              <div className="mx-auto max-w-7xl px-4 text-center sm:px-6 lg:px-8">
                <div className="mx-auto max-w-3xl">
                  ...
                  <p className="mt-6 text-lg text-slate-600 leading-8">
                    ...
                    hidratação em um único lugar. Simples, intuitivo e feito
                    para você.
                  </p>
                ...
                <div className="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  ...
                  <div className="relative rounded-2xl border border-slate-200 bg-white p-8 shadow-sm hover:shadow-md transition-shadow">
                    ...
                    <p className="mt-2 text-slate-600">
                      Defina metas diárias de água e acompanhe seu progresso
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-12 lg:grid-cols-3 lg:gap-8 text-center">
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <p className="mt-2 text-sm text-slate-500 max-w-xs">
                      Visualize seu progresso com gráficos simples e intuitivos
                      no seu dashboard.
                    </p>
                  </div>
                  <div className="flex flex-col items-center">

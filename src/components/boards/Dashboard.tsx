...
export default function Dashboard() {
    ...
    const fetchHydrationDaily = useHydrationStore((s) => s.fetchHydrationDaily);
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Card title="Hidratação " icon={GlassWaterIcon}>
                ...
                <div className="h-4 w-full bg-slate-200 rounded-full">
                    <div className={`h-full rounded-full transition-all duration-75 ${isGoalReached ? 'bg-green-400' : 'bg-blue-700'}`} style={{ width: `${progress}%` }} />
                </div>
